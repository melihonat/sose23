...
document.addEventListener('DOMContentLoaded', () => {
    ...
    var currentPlayer = inviterId; // Der Inviter startet default
    var player1Score = 0;
    var player2Score = 0;

    document.getElementById('current-player-name').innerText = inviterName;
    ...
    function endGame() {
      ...
      const gameResults = {
        ...
        verlauf: verlauf,
        gewinner: player1Score > player2Score ? inviterId : player1Score < player2Score ? InviteeId : null,
        initiator: inviterId,
        mitspieler: inviteeId
      };
